...
<aside id="sidebar" class="sidebar fixed left-0 top-0 z-50 h-screen w-72 overflow-y-auto text-white">
    ...
    <div class="mx-4 mt-4 rounded-[1.7rem] border border-white/10 bg-white/[0.06] p-4 shadow-2xl">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-sm font-bold">Pusat Toko</p>
                <p class="text-xs text-white/55">Bekasi</p>
            </div>
        </div>

        <div class="mt-4 grid grid-cols-2 gap-2 text-sm text-white/70">
            <span class="rounded-xl bg-white/[0.06] px-3 py-2">Bekasi</span>
            <span class="rounded-xl bg-white/[0.06] px-3 py-2">Jakarta</span>
